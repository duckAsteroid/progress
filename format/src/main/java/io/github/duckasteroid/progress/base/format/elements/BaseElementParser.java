...
public class BaseElementParser implements FormatParser {
  /**
   * A default map of parsers by their tag name.
   * @return a map of the default base element parsers
   */
  public Map<String, Function<String, FormatElement>> parsers() {
    ...
    result.put("prog",
        s -> new ProgressBar(Integer.parseInt(s.substring(3)), s.substring(0, 3).toCharArray()));
